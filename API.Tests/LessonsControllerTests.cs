...
public class LessonsControllerTests
{
    ...
    public async void GetLesson_ValidId()
    {
        ...
        _mockRepository
            .Setup(x => x.GetLesson(It.IsAny<int>(), It.IsAny<string>()))
            .Returns(Task.FromResult(new Result<GetLessonDto> { IsSuccess = true, Data = validLesson }));

        //Act
        var result = await _mockRepository.Object.GetLesson(id, username);
    ...
    public async void AddLesson_ValidLesson()
    {
        ...
        _mockRepository
            .Setup(x => x.AddLesson(It.IsAny<AddLessonDto>(), It.IsAny<string>()))
            .Returns(Task.FromResult(new Result<GetLessonDto> { IsSuccess = true, Data = validNewLesson }));

        //Act
        var result = await _mockRepository.Object.AddLesson(newLesson, username);
    ...
    public async void UpdateLesson_ValidId()
    {
        ...
        _mockRepository
            .Setup(x => x.UpdateLesson(It.IsAny<int>(), It.IsAny<UpdateLesssonDto>(), It.IsAny<string>()))
            .Returns(Task.FromResult(new Result<GetLessonDto> { IsSuccess = true, Data = validUpdatedLesson }));

        //Act
        var result = await _mockRepository.Object.UpdateLesson(id, updatedLesson, username);
    ...
    public async void DeleteLesson_ValidId()
    {
        ...
        _mockRepository
            ...
            .Returns(Task.FromResult(new Result<bool> { IsSuccess = true, Data = true }));
    ...
    public async void DeleteLesson_InvalidId()
    {
        ...
        _mockRepository
            .Setup(x => x.DeleteLesson(It.IsAny<int>()))
            .Returns(Task.FromResult(new Result<bool> { IsSuccess = false, ErrorMessage = "Lesson with the provided ID not found." }));
